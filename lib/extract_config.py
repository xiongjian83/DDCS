config = [
    ...
    ("Disconnect from Docker Cloud", "从 Docker 云断开连接"),
    ("Switch to Docker Cloud", "切换到 Docker 云"),
    ...
    ("Connected to Cloud: {0}", "连接到 Docker 云: {0}"),
    ("Create", "创建"),
    ...
    ("Docker Projects illustrations", "Docker 项目插图"),
    ("An all-in-one container workflow", "多合一容器工作流"),
    (
    ...
    ("Learn about Projects", "了解项目"),
    ("Projects are connected to your Docker account.", "项目已连接到你的 Docker 帐户。"),
    ...
    ("Fix this CVE in base image:", "在基础镜像中修复此漏洞:"),
    ("{0}Update base image", "{0}更新基础镜像"),
    ...
    ("Policy impact:", "策略影响:"),
    ('"{0}" will have {1} {2} violations.', '"{0}" 将会有 {1} {2} 违规。'),
    ("Benefits:", "优点:"),
    ...
    ("Recommended fixes for base image {0}{1}", "基础镜像 {0}{1} 的推荐修复"),
    ...
    ("Docker Projects run command illustration", "Docker 项目运行命令插图"),
    ...
    ("Images view", "镜像视图"),
    ("Project name and owner", "项目名称和拥有者"),
    ("Pick the owner, and give your project a memorable name.", "选择拥有者，并为你的项目取一个令人难忘的名字。"),
    ("Selected folder and repository", "选定的文件夹和仓库"),
    ("Project name", "项目名称"),
    ("Create project", "创建项目"),
    ...
    ("Docker", None),
    ("Adds access to your Docker containers, images and volumes", "添加对 Docker 容器、镜像和卷的访问权限"),
    ("Adds access to your Kubernetes cluster", "添加对 Kubernetes 集群的访问权限"),
    (
