config = [
    ...
    ("Digest", "摘要"),
    ("Beta", "测试"),
    ("No metadata available for line ${n.line}.", "行 ${n.line} 没有可用的元数据。"),
    ...
    ('Unable to pull ${(0,b.kL)(A,!1,!0,!0,"no-digest")}', '无法拉取 ${(0,b.kL)(A,!1,!0,!0,"no-digest")}'),
    ('Pulling ${(0,b.kL)(A,!1,!0,!0,"no-digest")} canceled', '取消拉取 ${(0,b.kL)(A,!1,!0,!0,"no-digest")}'),
    ("Filters", "过滤器"),
    ("Select all", "全选"),
    ...
    ("Empty volume", "清空卷"),
    ("Delete volume", "删除卷"),
    ("You are about to delete the volume '${e.Name}' and all its data.", "你即将删除卷 '${e.Name}' 及其所有数据。"),
    ("Stored data", "存储的数据"),
    ...
    ("Docker is running ${h} containers.", "Docker 正在运行 ${h} 个容器。"),
    ...
    ("Last pushed ${c}", "最后推送于 ${c}"),
    ("No scan available", "没有扫描可用"),
    ("Created {0}{1}{2}", "创建于 {0}{1}{2}"),
    ("Global Search", "全局搜索"),
    ("Search results for “{0}”", "“{0}” 的搜索结果"),
    ("Images (${z.images.count})", "镜像（${z.images.count}）"),
    ("Containers (${z.containersCompose.count})", "容器（${z.containersCompose.count}）"),
    ("Volumes (${z.volumes.count})", "卷（${z.volumes.count}）"),
    ("Extensions (${z.extensions.count})", "扩展（${z.extensions.count}）"),
    ("Docs (${z.docs.count})", "文档（${z.docs.count}）"),
    ("Hide all", "全部隐藏"),
    ("Show all", "全部显示"),
    (
    ...
    ("Invalid path", "无效的路径"),
    ("${o.path} already exists.", "${o.path} 已经存在。"),
    ...
    ("Id: ${e.Id}", None),
    ("Delete network", "删除网络"),
    ("You are about to delete the network '${e.Name}'.", "您即将删除网络 '${e.Name}'。"),
    ...
    ('Unable to pull ${(0,P.kL)(e,!1,!0,!0,"no-digest")}', '无法拉取 ${(0,P.kL)(e,!1,!0,!0,"no-digest")}'),
    ('Pulling ${(0,P.kL)(e,!1,!0,!0,"no-digest")} canceled', '取消拉取 ${(0,P.kL)(e,!1,!0,!0,"no-digest")}'),
    ...
    ("Are you sure you want to disconnect container ${T.label}?", "你确定要断开容器 ${T.label} 的连接吗？"),
    ("Disconnect", "断开"),
    ("Alias: ", "别名: "),
    ("Status: ", "状态: "),
    ("Ports:\xa0", "端口:\xa0"),
    ...
    ("This will change your Docker context to: '${S}'.", "这将会把您的 Docker 上下文更改为: '${S}'。"),
    ...
    ("You're about to pull ${Q}, create a new container, and run it.", "您即将拉取 ${Q}，创建一个新的容器并运行它。"),
    ...
    (
        ...
        "在你的项目目录中找不到 ${o.composeFile} 文件。编辑你的运行配置，或者检查项目是否有更改。",
    ),
    ...
    ("Image layer ${e.index}", "镜像层 ${e.index}"),
    ...
    ("Rosetta is only available with ${X}", "Rosetta 仅在 ${X} 上可用"),
    (
    ...
    (
        ...
        "未找到账户 ${M} 的构建器 ${L} 或你无权访问。",
    ),
    ("Loading builders", "构建器加载中"),
    ("Connecting...", "连接中..."),
    ("Successfully connected to ${L}", "成功连接到 ${L}"),
    (
    ...
    ("Error: Cannot show content of ${i} (not regular file)", "错误: 无法显示内容 ${i}（非常规文件）"),
    (
        "Error: Cannot open editor for file ${i}, the maximum limit is 10Mb.",
        "错误: 无法在编辑器中打开文件 ${i}，最大限制是 10Mb。",
    ),
    ("Error: Cannot show content of ${i}", "错误: 无法显示内容 ${i}"),
    ("Fetching content of {0}...", "获取 {0} 的内容中..."),
    ("Do you want to save changes to ${r.path}?", "你想要保存对 ${r.path} 的更改吗？"),
    ...
    ("This disconnects container ${t} from the ${e} network.", "这将断开容器 ${t} 与 ${e} 网络的连接。"),
    ...
    ("${t.path} already exists.", "${t.path} 已经存在。"),
    ("Welcome Survey", "欢迎调查"),
    ...
    ("Specific version: ${F?.purlFields.version}", "特定版本: ${F?.purlFields.version}"),
    ("Any package", "任意软件包"),
    ("Navigate away?", "离开导航？"),
    ...
    (
        ...
        '出处 ${n.annotations?.["in-toto.io/predicate-type"]?.replace("https://slsa.dev/provenance/","")??""}',
    ),
    ...
    (
        ...
        '用于启动此容器的镜像已被 ${t.main?"重新标记":"取消标记"}。这是创建容器时的标签。',
    ),
    ("(was {0})", "（是{0}）"),
    ("Inspect", "检查"),
    ("Stats", "统计"),
